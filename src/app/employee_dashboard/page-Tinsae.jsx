      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 py-8 space-y-10">
        ...
        <section className="grid grid-cols-1 lg:grid-cols-5 gap-5">
          ...
          <div className="lg:col-span-2 grid grid-cols-2 gap-4">
            <StatCard icon="mail" value={unreadEmailCount} label="Inbox" href="/internal_email" />
...
function StatCard({ icon, value, label, href }) {
  ...
  if (href) {
    return (
      <Link href={href} className="stat-card p-4 flex flex-col items-center justify-center text-center">
        {content}
      </Link>
    );
  }
